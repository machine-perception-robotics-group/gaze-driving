...
from drive import CoILAgent, GazeAgent, ABNAgent
...
def driving_benchmark(checkpoint_number, gpu, town_name, experiment_set, exp_batch, exp_alias,
                      params, control_filename, task_list, save_images):
    """
    ...
    try:
        ...
        if g_conf.MODEL_TYPE == "coil-icra" or g_conf.MODEL_TYPE == "normal-drive" or g_conf.MODEL_TYPE == "coil-gaze-loss":
            coil_agent = CoILAgent(checkpoint, town_name)
        elif g_conf.MODEL_TYPE == "coil-gaze":
            coil_agent = GazeAgent(checkpoint, town_name, exp_batch, exp_alias, "drive")
        elif g_conf.MODEL_TYPE == "abn-drive":
            coil_agent = ABNAgent(checkpoint, town_name, exp_batch, exp_alias, "drive")
        ## 追加：特徴マップ保存用
        ...
        run_driving_benchmark(coil_agent, experiment_set, town_name,
                              ...
                              , True, params['host'], port, save_images, params['save_features'], use_gaze)
...
def execute(gpu, exp_batch, exp_alias, drive_conditions, params, save_images):
    """
            ...
            while not maximun_checkpoint_reach(latest, g_conf.TEST_SCHEDULE):
                ...
                if is_next_checkpoint_ready(g_conf.TEST_SCHEDULE,
                    ...
                    driving_benchmark(latest, gpu, town_name, experiment_set, exp_batch,
                                      exp_alias, params, control_filename, task_list, save_images)

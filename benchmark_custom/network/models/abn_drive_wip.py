...
class CoABNDrive(nn.Module):
    def __init__(self, params):
        ...
        if 'conv' in params['extractor']:
            ...
            elif 'cifer' == params['extractor']['res']['type']:
        ...
        if resnet:
            # cifarモデル以外は指定なし
            pooling = 2
            if 'cifar' in params['extractor']['res']['type']:
                pooling = params['extractor']['res']['pooling'] if \
                            not params['extractor']['res']['pool_before'] else None

...
class MobileNetV2CMD(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.):
        super(MobileNetV2CMD, self).__init__()
        ...
        self.deconv1 = nn.ConvTranspose2d(241, 120, 5, stride=1)
